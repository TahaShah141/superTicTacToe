...
function App() {
  ...
  return (
    <div className={`flex flex-col justify-center h-screen items-center ${winner == 1 ? "bg-blue-400" : winner == -1 ? "bg-red-500" : "bg-neutral-900"} gap-4 sm:gap-8 overflow-y-hidden`}>
